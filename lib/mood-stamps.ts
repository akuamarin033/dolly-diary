...
export const MOOD_STAMPS: MoodStamp[] = [
  ...
  { id: "love", label: "恋", source: require("@/assets/images/mood-stamps/mood-love.png") },
  { id: "angel", label: "天使", source: require("@/assets/images/mood-stamps/mood-angel.png") },
  ...
  { id: "sleepy", label: "眠い", source: require("@/assets/images/mood-stamps/mood-sleepy.png") },
...
export const WEATHER_STAMPS: WeatherStamp[] = [
  ...
  { id: "umbrella", label: "傘", source: require("@/assets/images/weather-stamps/weather-umbrella.png") },
