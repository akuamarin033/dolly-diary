...
const translations = {
  ...
  "diary.photoError": { ja: "写真の選択に失敗しました。もう一度お試しください。", en: "Failed to select photo. Please try again." },
  "diary.photoPermissionIOS": { ja: "写真ライブラリへのアクセスを許可してください。設定アプリから変更できます。", en: "Please allow access to your photo library. You can change this in Settings." },
  "diary.photoPermissionAndroid": { ja: "写真へのアクセスを許可してください。設定から変更できます。", en: "Please allow access to your photos. You can change this in Settings." },
  "diary.photoTypeError": { ja: "この写真は読み込めませんでした。別の写真を選んでください。", en: "This photo could not be loaded. Please choose a different photo." },
